...
@Composable
fun ValidatedField(
  value: String, enabled: Boolean, onValidate: (String) -> ValidationResult, onIme: () -> Unit
) {
...
fun ValidatedForm(
  ...
  var state by remember {
    mutableStateOf(validators.associateWith {
  ...
  state.entries.forEachIndexed { index, entry ->
    ValidatedField(entry.value.first, onValidate = {
